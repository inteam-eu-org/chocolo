...
### Cedo/Vince
Chcolo
- [ ] X, donnes le telephone a X. 
    - [ ] Donnes un avis impopulaire. Si tu n’arrives pas a créer la discorde, tu prends 4 gorgées, sinon distribues les !
- [ ] X, tu es Julien Lepers. Choisis un thème, et jusqu’à nouvel ordre, tu peux poser 3 questions pour faire boire un joueur inculte. S’il trouve la réponse, c’est toi qui bois !
- [ ] Dissolution de l’assemblée ! Votez pour un maire
    - [ ] Le gagnant peut distribuer un cul sec
- [ ] Dissolution de l’assemblée ! Votez pour un maire.
    - [ ] Le gagnant distribue 3 gorgées a tout ses électeurs
- [ ] X, dis un mot !
    - [ ] Les prénoms des joueurs qui commencent par la meme lettre que ce mot distribue 2 gorgées
- [ ] X, imite un autre joueur present de ton choix. Le premier qui devine distribue 3 gorgées.
- [ ] X, lances un theme de ton choix. Le premier qui ne trouve pas boit un coup.
- [ ] X, Lances un tu préfères. La team perdante boit 2 gorgées
- [ ] X, mimes ta position sexuelle préférée ou boit 5 gorgées.
- [ ] Du plus jeune au plus vieux, donnez votre age. 
    - [ ] Respect aux anciens, chacun boit la différence d’age avec le doyen. 
    - [ ] Gen Z en force #DAB ! Chacun boit la différence avec le cadet du groupe. 
- [ ] X, lances un j’ai déjà/j’ai jamais. Ceux qui ne l’ont pas fait boivent une gorgée. 
- [ ] Saint-Valentin ! Chaque joueur est maintenant en couple avec la personne en face de lui jusqu’a nouvel ordre. 
- [ ] Parmi les joueurs, qui serait le plus susceptible d’utiliser une application de rencontre. Tout le monde vote, et le char boit une gorgée.
- [ ] X, trouves un similitude entre plusieurs personnes. Nommes-les. Le premier qui trouve le point commun distribue 5 gorgées. 
- [ ] Kamikaze ! X, choisis un joueur pour boire un shot avec toi. 
- [ ] X, inventes une règle.
- [ ] Tout le monde votes pour le Don Juan du groupe, cette personne boit 3 gorgées. 
- [ ] X, donnes le nom de tous les joueurs. 2 gorgées en cas d’erreurs.
- [ ] X, tu es le roi du freeze jusqu’à nouvel ordre. 
- [ ] X, tu es le sheriff. Defies n’importe qui au moins que moins pour le mettre en prison. Cette personne est muette jusqu’a nouvel ordre
...
- [ ] Jeu du titre jusqu’à la fin de la soirée ! Le premier qui dit titre après une phrase qui pourrait un titre de vidéo X distribue 3 gorgées. 
- [ ] Jeu du doigt. Le perdant finit le verre
- [ ] X et X doivent échanger un vêtement ou boive un coup.
- [ ] X, tu deviens Steven Spielberg. Prends une photo des participants dans les poses que tu veux. 
- [ ] Nouvelle règle ! Chacun s’appelle par le prénom du joueur à sa droite. Chaque erreur … tu bois !
- [ ] Concours de biteBox… Non je rigole!
- [ ] X, mime un animal que tu baiserais bien. 
    - [ ] Si tu l’as vraiment fait, rend toi au poste de police le plus proche. 
- [ ] X, tu deviens Lucky Luke. Tu as trois chances de tirer sur X Dalton. Si il esquive les trois tirs avec sa tete, c’est toi qui boit. 
